...
import AdminManagePanel from "./components/admin/AdminManage";
import AdminCreditsAndNotificationsPanel from "./components/admin/AdminCreditsAndNotifications";
import AdminGroupsListPanel from "./components/admin/AdminGroupsList";
import AdminDashboardPanel from "./components/admin/AdminDashboard";
import AdminInterrogationPanelComponent from "./components/admin/AdminInterrogationPanel";
import AdminSetupCheckPanel from "./components/admin/AdminSetupCheck";
import AdminParticipantPreviewPanel from "./components/admin/AdminParticipantPreview";
import HeaderPanel from "./components/shell/Header";
import LandingPagePanel from "./components/shell/LandingPage";
import LoginScreenPanel from "./components/shell/LoginScreen";
import SuspectDashboardPanel from "./components/suspect/SuspectDashboard";
import ParticipantDashboardPanel from "./components/participant/ParticipantDashboard";
import ParticipantCluesPanel from "./components/participant/ParticipantClues";
import ParticipantSuspectsPanel from "./components/participant/ParticipantSuspects";
...
import {
  ImageModal as AppImageModalBlock,
  AgendaBlock as AppAgendaBlock,
  NotificationsBlock as AppNotificationsBlock,
  TransactionsBlock as AppTransactionsBlock,
  NoGroupScreen as AppNoGroupScreen,
  ParticipantGroupBar as AppParticipantGroupBar,
} from "./components/shared/AppBlocks";
...
export default function App() {
  ...
  const ImageModal = () => <AppImageModalBlock ctx={getComponentContext()} />;
  ...
  const AgendaBlock = () => <AppAgendaBlock ctx={getComponentContext()} />;
  const NotificationsBlock = () => (
    <AppNotificationsBlock ctx={getComponentContext()} />
  );
  const TransactionsBlock = () => (
    <AppTransactionsBlock ctx={getComponentContext()} />
  );
  const NoGroupScreen = () => <AppNoGroupScreen ctx={getComponentContext()} />;
  const ParticipantGroupBar = () => (
    <AppParticipantGroupBar ctx={getComponentContext()} />
  );
  const ParticipantDashboard = () => (
    <ParticipantDashboardPanel ctx={getComponentContext()} />
  );
  ...
  const ParticipantClues = () => (
    <ParticipantCluesPanel ctx={getComponentContext()} />
  );
  const ParticipantSuspects = () => (
    <ParticipantSuspectsPanel ctx={getComponentContext()} />
  );
  const AdminParticipantPreview = () => (
    <AdminParticipantPreviewPanel ctx={getComponentContext()} />
  );
  const AdminSetupCheck = () => (
    <AdminSetupCheckPanel ctx={getComponentContext()} />
  );
  ...
  const AdminCreditsAndNotifications = () => (
    <AdminCreditsAndNotificationsPanel ctx={getComponentContext()} />
  );

  const AdminGroupsList = () => (
    <AdminGroupsListPanel ctx={getComponentContext()} />
  );
  ...
  const AdminInterrogationPanel = () => (
    <AdminInterrogationPanelComponent ctx={getComponentContext()} />
  );

  const SuspectDashboard = () => (
    <SuspectDashboardPanel ctx={getComponentContext()} />
  );
  const LandingPage = () => <LandingPagePanel />;

  const LoginScreen = () => <LoginScreenPanel ctx={getComponentContext()} />;
